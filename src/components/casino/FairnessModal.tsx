...
export function FairnessModal() {
  ...
  return (
    <Dialog open={fairnessOpen} onOpenChange={setFairnessOpen}>
      <DialogContent className="max-w-lg rounded-[28px] border border-white/[0.08] bg-[#0e0e10] p-5 text-white shadow-2xl sm:p-7">
        <DialogHeader>
          ...
          <DialogDescription className="text-[13px] leading-6 text-white/60">
            ...
            <code className="mt-3 block rounded-2xl border border-black/10 bg-white/[0.06] px-3 py-2.5 font-mono text-[10.5px] text-white/75">
...
function Field({ label, value, mono }: { label: string; value: string; mono?: boolean }) {
  return (
    <div>
      ...
      <div className="flex items-center gap-2 rounded-2xl border border-black/10 bg-white/[0.06] px-3.5 py-3">
